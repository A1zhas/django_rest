...
class PostTestCase(TestCase):
    ...
    def setUp(self):
        ...
        user = BlogUser.objects.create_user(username='test_user', email='test@test.com', password='Aaaa1234')
...
class PostTestCaseFaker(TestCase):
    ...
    def setUp(self):
        ...
        user = BlogUser.objects.create_user(username=faker.name(), email='test@test.com', password='Aaaa1234')
